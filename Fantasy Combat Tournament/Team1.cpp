...
** Author: William Dam
** Date: 11-19-2019
** Description: Team1.cpp is the implementation file for the
...
*********************************************************************/
void Team1::addBack(std::string name, int choice) {
...
void Team1::printTeam() {
	...
	// Otherwise, queue has nodes, so do this
		...
		std::cout << "Team 1 looks like this: " << std::endl;
...
** at head.
*********************************************************************/
void Team1::setHeadStrength(int p) {
